...
public class HCTLootNumberProviderTypes {
  ...
  public HCTLootNumberProviderTypes() {
  }

  private static LootNumberProviderType register(String id, JsonSerializer<? extends LootNumberProvider> jsonSerializer) {
    return (LootNumberProviderType)Registry.register(Registries.LOOT_NUMBER_PROVIDER_TYPE, new Identifier(id), new LootNumberProviderType(jsonSerializer));
  }
